...
import { ObjectiveGroup, defaultValues } from '../../features/shared/components/fieldgroups/ObjectiveGroup';
...
describe('ObjectiveGroup', () => {
    ...
    describe('rendering', () => {
        ...
        it('should render Add Prerequisite button', () => {
            render(<ObjectiveGroup />);
            expect(screen.getByRole('button', { name: 'Add Prerequisite' })).toBeInTheDocument();
        });
    });
